...
$(function() {
    ...
    async function invest() {
       ...
       var tarif =  $('input[name="mavro"]:radio:checked').val();
        console.log(contractAddress);
        var amount  = parseInt(amount);
        console.log('tarrif', typeof tarif);
        if( !(amount === parseInt(amount, 10)))
        {
            alert('enter valid number of tron')
        }else if (tarif == '0' && amount < 50)
        {
            alert('Min is 50 tron');
        }else if (amount < 200 )
        {
